...
const features = [
  { icon: Route, title: "Planificación de rutas", desc: "Crear, asignar y despachar rutas por zona y capacidad de vehículo." },
  { icon: Truck, title: "Gestión de flota", desc: "Control de vehículos, capacidades y conductores asignados." },
  { icon: MapPin, title: "Seguimiento en terreno", desc: "Registro de paradas, novedades y entregas durante la operación." },
  { icon: BarChart3, title: "Cierre de ruta", desc: "Resumen de entregas exitosas, fallidas y novedades por turno." },
  { icon: ShieldCheck, title: "Roles operativos", desc: "Accesos diferenciados para Despachador, Conductor y Admin de Flota." },
  { icon: Clock, title: "Operación continua", desc: "Pensado para la dinámica diaria del equipo de última milla." },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-16 min-h-[80vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Operación logística de última milla" className="w-full h-full object-cover opacity-40" width={1920} height={1080} />
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-20 text-center w-full">
          ...
          <h1 className="text-5xl md:text-6xl font-bold leading-[1.05] mb-6">
            Gestión de <span className="gradient-primary-text">rutas y flota</span> para tu operación.
          </h1>
          <p className="text-lg text-subtle mb-8 max-w-2xl mx-auto leading-relaxed">
            LogisticsRoutes centraliza el despacho, la asignación de conductores y el seguimiento de entregas para el equipo operativo.
          </p>
      ...
      <section id="features" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mt-3 mb-4">Lo que aborda la plataforma</h2>
          </div>
        ...
        <div className="max-w-3xl mx-auto card-elevated p-12 md:p-14 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-subtle text-base mb-8 max-w-xl mx-auto">
              Ingresa con las credenciales que te fueron entregadas. Si necesitas acceso, contacta a tu supervisor.
            </p>
