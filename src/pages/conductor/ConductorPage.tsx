...
export default function ConductorPage() {
  ...
  const [estado, setEstado] = useState<"Confirmada" | "En Tránsito">(
    ruta.estado === "Confirmada" ? "Confirmada" : "En Tránsito",
  );
      ...
      <div className="w-full max-w-[480px]">
        ...
        <div className="card-navy mx-4 mt-4 p-4">
          ...
          <p className="text-white/60 text-sm">
            {ruta.zona}, {ruta.ciudad}
          </p>
          <p className="text-white/60 text-sm">
            {paradas.length} paradas · {ruta.pesoTotal} kg · NHR {ruta.vehiculoAsignado}
          </p>
        </div>
        {estado === "Confirmada" && (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {parada.status === "Pendiente" && (
                      <button
                        onClick={() => navigate(`/conductor/parada/${parada.numero}`)}
